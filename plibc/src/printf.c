...
static __inline unsigned int skip_to(const unsigned char *format) {
  unsigned int nr;
...
static __inline int write_pad(struct arg_printf* fn, int len, int padwith) {
  int nr=0;
...
int __dtostr(double d,char *buf,unsigned int maxlen,unsigned int prec,unsigned int prec2) {
  ...
  e=((u.l>>52)&((1<<11)-1))-1023;
#else
#if __BYTE_ORDER == __LITTLE_ENDIAN
  e=(((((unsigned long*)&d)[1])>>20)&((1<<11)-1))-1023;
#else
  e=(((*((unsigned long*)&d))>>20)&((1<<11)-1))-1023;
#endif
#endif
